...
messagesToSend.push({
      ...
      "contents": {
        ...
        "body": {
          ...
          "contents": [
			...
			{ "type": "button", "action": { "type": "uri", "label": "เว็บเช็คราคาน้ำมัน", "uri": "https://sanyan-app.vercel.app/fuel", "style": "primary", "margin": "sm"  },
  ...
  // 6. กรณีใช้ RegEx ตรวจจับคำ (เช่น ราคาน้ำมัน)
    ...
    messagesToSend.push({
      "type": "text",
      "text": "เช็คราคาน้ำมันล่าสุดได้ที่: https://script.google.com/macros/s/AKfycbyrimYzpFj9qEUgATD5n1s8YqnhmAyFZSHH80AAf0NWIvZ7VSKOAB9zkTFawRC1gBIaTg/exec"
    });
  }
